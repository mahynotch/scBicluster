...
from biclustlib.algorithms import las, plaid, xmotifs, ModifiedChengChurchAlgorithm
...
@time_deco
def modifiedcc_gen(adata, num_cluster=5):
    model = ModifiedChengChurchAlgorithm(num_cluster)
